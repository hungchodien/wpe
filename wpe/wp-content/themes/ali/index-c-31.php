...
<?php include_once ("slider-index.php");?>
    ...
    <?php
//    $loopp = new WP_Query( array( 'post_type' => 'book', 'posts_per_page' => 3) );
//    if($loopp->have_posts()){
...
<div style="display: none">
    ...
    <div class="col-xs-12">
        <?php get_template_part( 'testTaxonomiesPostType' ); ?>
    </div>
    <div class="col-xs-12">
        <?php get_template_part( 'testTaxonomies' ); ?>
    </div>
    <div class="col-xs-12">
        <?php get_template_part( 'testPostType' ); ?>
    </div>
</div>
